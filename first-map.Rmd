...
However, it does not display outline color properly.

```{r}
tmap::tmap_mode("view")
tmap::tm_shape(osm_data$osm_multipolygons) +
  tmap::tm_basemap("OpenStreetMap") +
  tmap::tm_borders(col = "red", lwd = 10)
```
